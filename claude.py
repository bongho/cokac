            ...
            if event_type == "assistant":
                ...
                for block in content:
                    if block.get("type") == "tool_use":
                        ...
                        yield f"__STATUS__:{tool_name}", None, None
                full_text = "".join(
...
async def run(
    ...
    """Run Claude and return full result (non-streaming). Retries once on failure."""
    cmd = [
        CLAUDE_BIN,
        "--print",
        "--output-format", "json",
    ...
    for attempt in range(2):
        ...
        try:
            ...
            if not data.get("result") and attempt == 0:
    ...
    return ClaudeResult(text="", session_id="", cost_usd=0.0)
